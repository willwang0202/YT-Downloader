// Default API endpoint — points to the Cloudflare Worker.
...
window.YT_DOWNLOADER_API = 'https://yt-downloader-willwang0202.zeabur.app';
window.YT_DOWNLOADER_VERSION = '1.3.0';
